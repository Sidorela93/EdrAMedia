            ...
            <ul>
                ...
                <li data-index="rs-18" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="revolution/assets/100x50_59345-slider-bg.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    ...
                    <div class="tp-caption   tp-resizeme rs-parallaxlevel-2"
                         ...
                         data-paddingbottom="[0,0,0,0]"
                         data-paddingleft="[0,0,0,0]"
                         style="z-index: 6;"><img src="images/INNOVATION.png" alt="" data-ww="['331px','331px','331px','331px']" data-hh="['287px','287px','287px','287px']" data-no-retina> </div>
                    <!-- LAYER NR. 3 -->
                    <div class="tp-caption tp-resizeme color-summer-sky"
                         ...
                         data-paddingbottom="[0,0,0,0]"
                         data-paddingleft="[0,0,0,0]"
                         style="z-index: 7; min-width: 556px; max-width: 556px; white-space: nowrap; font-size: 50px; line-height: 75px; font-weight: 700; letter-spacing: 0px;font-family: 'Libre Bodoni', serif; font-style: italic; ">Innovation</div>
                    <!-- LAYER NR. 4 -->
                    <div class="tp-caption   tp-resizeme darkcolor"
                         data-x="['left','center','center','center']" data-hoffset="['8','0','0','0']"
                         data-y="['top','middle','middle','middle']" data-voffset="['365','95','0','10']"
                         ...
                         data-paddingbottom="[0,0,0,0]"
                         data-paddingleft="[0,0,0,0]"
                         style="z-index: 8; min-width: 646px; max-width: 646px; white-space: nowrap; font-size: 12px; line-height: 22px; font-weight: 400; letter-spacing: 0px; font-family: 'Graphik';">Innovation is the only way to build a future for our country. Innovation is a daily need for the health sector when it comes to <strong>optimizing efficiency</strong> and <strong>improving treatment</strong>. Innovation is about moving away from gradual improvements to launch a process of <strong>evolutionary change.</strong> </p>
                    </div>
                    <!-- LAYER NR. 5 -->
                    ...
                    <!-- LAYER NR. 12 -->
                    <div class="tp-caption tp-resizeme"
                         data-x="['left','center','center','center']" data-hoffset="['-80','0','0','0']"
                         data-y="['middle','middle','middle','middle']" data-voffset="['100','200','90','120']"
                    ...
                    <!--div class="tp-caption   tp-resizeme darkcolor"
                         ...
                         data-paddingbottom="[0,0,0,0]"
                         data-paddingleft="[0,0,0,0]"
                         style="z-index: 17; min-width: 556px; max-width: 556px; white-space: nowrap; font-size: 60px; line-height: 75px; font-weight: 700; letter-spacing: 0px;font-family: 'Libre Bodoni', serif;">&nbsp;</div-->
                </li>
                <!-- SLIDE 2 -->
                <li data-index="rs-32" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="revolution/assets/100x50_59345-slider-bg.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    ...
                    <div class="tp-caption   tp-resizeme rs-parallaxlevel-2"
                         ...
                         data-paddingbottom="[0,0,0,0]"
                         data-paddingleft="[0,0,0,0]"
                         style="z-index: 6;"><img src="images/SUSTAINABILITY-LR.jpeg" alt="" data-ww="['550px','550px','550px','550px']" data-hh="['auto','auto','auto','auto']" data-no-retina> </div>
                    <!-- LAYER NR. 3 -->
                    <div class="tp-caption tp-resizeme color-summer-sky"
                         data-x="['right','center','center','center']" data-hoffset="['-125','0','0','0']"
                         data-y="['top','top','top','top']" data-voffset="['270','200','100','55']"
                         data-fontsize="['60','50','40','40']"
                         data-lineheight="['75','75','75','40']"
                         data-width="['556','556','556','300']"
                         ...
                         data-paddingbottom="[0,0,0,0]"
                         data-paddingleft="[0,0,0,0]"
                         style="z-index: 7; min-width: 556px; max-width: 556px; white-space: nowrap; font-size: 50px; line-height: 75px; font-weight: 700; letter-spacing: 0px;font-family: 'Libre Bodoni', serif; font-style: italic; ">Sustainability</div>
                    <!-- LAYER NR. 4 -->
                    <div class="tp-caption   tp-resizeme color-black"
                         data-x="['right','center','center','center']" data-hoffset="['0','0','0','0']"
                         data-y="['top','top','top','top']" data-voffset="['365','95','0','10']"
                         data-whitespace="normal"
                         data-width="['656','650','550','440']"
                         data-fontsize="['16','15','15','15']"
                         data-lineheight="['22','22','22','22']"
                         ...
                         data-paddingleft="[0,0,0,0]"
                         style="z-index: 8; min-width: 646px; max-width: 646px; white-space: nowrap; font-size: 12px; line-height: 22px; font-weight: 400; letter-spacing: 0px; font-family: 'Graphik';">Making sustainable choices is about focusing on <strong>creating value</strong> rather than profit. It's about putting <strong>energy and resources into the community</strong> rather than pursuing personal interests. It's about reinvesting profits into the <strong>area</strong> in which they are generated. It's about believing in the possibility of creating <strong>companies with a human face</strong> - companies that are ethical and focused on <strong>community well-being.</strong>
                    </div>
                    <!-- LAYER NR. 5 -->
                    <div class="tp-caption   tp-resizeme"
                         data-x="['left','left','left','left']" data-hoffset="['-331','-149','-162','-162']"
                ...
                <li data-index="rs-36" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="revolution/assets/100x50_59345-slider-bg.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    ...
                    <div class="tp-caption tp-resizeme color-summer-sky"
                         ...
                         data-paddingbottom="[0,0,0,0]"
                         data-paddingleft="[0,0,0,0]"
                         style="z-index: 7; min-width: 556px; max-width: 556px; white-space: nowrap; font-size: 50px; line-height: 75px; font-weight: 700; letter-spacing: 0px;font-family: 'Libre Bodoni', serif; font-style: italic; ">Resilience</div>
                    <!-- LAYER NR. 4 -->
                    <div class="tp-caption   tp-resizeme darkcolor"
                         data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                         data-y="['top','middle','middle','middle']" data-voffset="['350','95','0','10']"
                         data-whitespace="normal"
                         data-width="['656','650','550','440']"
                         data-fontsize="['16','15','15','15']"
                         data-lineheight="['22','22','22','22']"
                         ...
                         data-paddingbottom="[0,0,0,0]"
                         data-paddingleft="[0,0,0,0]"
                         style="z-index: 8; min-width: 646px; max-width: 646px; white-space: nowrap; font-size: 12px; line-height: 22px; font-weight: 400; letter-spacing: 0px;font-family:'Graphik';">The current situation requires us to <strong>revolutionize our thought processes</strong> to predict and effectively tackle the complexities of the world in which we live. Our day-to-day reality is much more complex than it may seem, and in an era of such dramatic change, the only wise move is <strong>to act like revolutionaries</strong>.
                    </div>
                    <!-- LAYER NR. 5 -->
                    <div class="tp-caption   tp-resizeme"
                         data-x="['left','left','left','left']" data-hoffset="['-331','-149','-162','-162']"
                    ...
                    <div class="tp-caption tp-resizeme"
                         data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                         data-y="['middle','middle','middle','middle']" data-voffset="['50','200','90','120']"
                         data-frames='[{"from":"y:50px;opacity:0;","speed":1000,"to":"o:1;","delay":800,"ease":"Power4.easeInOut"},{"delay":"wait","speed":1000,"to":"y:[175%];","mask":"x:inherit;y:inherit;s:inherit;e:inherit;","ease":"Power2.easeInOut"},{"frame":"hover","speed":"300","ease":"Power1.easeInOut","to":"o:1;rX:0;rY:0;rZ:0;z:0;","style":"c:rgba(255, 255, 255, 1.00);bc:rgba(255, 255, 255, 1.00);bw:2px 2px 2px 2px;"}]'
                         data-textAlign="['center','center','center','center']"
                         data-width="['160','160','160','160']"
                         style="z-index:99; max-width: 960px">
